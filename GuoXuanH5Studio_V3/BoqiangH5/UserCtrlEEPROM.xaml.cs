...
namespace BoqiangH5
{
    ...
    public partial class UserCtrlEEPROM : UserControl
    {
        ...
        public event EventHandler RequestReadMCUParamEvent;
                ...
                while ((strLine = sr.ReadLine()) != null)
                {
                    ...
                    switch (arrVal[0])
                    {
                        ...
                        case "预充控制": // Off
                            ...
                            break;
                        case "当过充电、温度保护导致关闭充电MOS，当放电时，MTP控制充电MOS": // On
        ...
        public void SetResistanceValue(string val)
        {
            tbCur_Res.Text = val;
        }
    }
