...
namespace BoqiangH5Repository
{
    ...
    {
        //static string strLoadCfgFile = "BoqiangV3\\ProtocolFiles\\bq_config_info.xml";   //程序合并时使用    
        ...
        #region 配置文件路径
        //程序合并时使用
        //static string strBqProtocolFile = "BoqiangV3\\ProtocolFiles\\bq_h5_bms_info.xml";
        //static string strDdProtocolFile = "BoqiangV3\\ProtocolFiles\\didi_h5_bms_info.xml";
        ...
        public static List<string> LoadUpdateInfo(string filepath)
        {
            ...
            {
                XmlDocument xmlDoc = new XmlDocument();
                xmlDoc.Load(filepath);                   //加载文件
                XmlNode root = xmlDoc.DocumentElement;       //查找根节点
                XmlNode subNode = root.SelectNodes("update")[0];      
                XmlNodeList nodeList = subNode.ChildNodes;
        ...
        public static void SaveUpdateInfo(List<string> list,string filepath)
        {
            if (!File.Exists(filepath))
            {
                return;
